...
IMAGES_DIRECTORY_PATH = join(PWD, ASSETS_DIRECTORY_NAME, "images")
FONTS_DIRECTORY_NAME = "fonts"
FONTS_DIRECTORY_PATH = join(PWD, ASSETS_DIRECTORY_NAME, "fonts")
MUSIC_DIRECTORY_NAME = "music"
MUSIC_DIRECTORY_PATH = join(PWD, ASSETS_DIRECTORY_NAME, "music")
ICON_PATH = join(PWD, IMAGES_DIRECTORY_PATH, "ufo.png")
BACKGROUND_MUSIC_PATH = join(PWD, MUSIC_DIRECTORY_PATH, "background.wav")
BULLET_SHOOTING_SOUND_PATH = join(PWD, MUSIC_DIRECTORY_PATH, "laser.wav")
EXPLOSION_SOUND_PATH = join(PWD, MUSIC_DIRECTORY_PATH, "explosion.wav")
BULLET_SHOOTING_SOUND_PATH = join(PWD, MUSIC_DIRECTORY_PATH, "laser.wav")
